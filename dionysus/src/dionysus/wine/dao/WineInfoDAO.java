...
public interface WineInfoDAO {
	...
	public ArrayList<WineInfo> selectWinePriceMin(Connection conn, int wineInfoPrice)throws SQLException;
	public int wineInfoCount(Connection conn)throws SQLException;
	public ArrayList<WineInfo> selectWineOrigin(Connection conn, String wineInfoOrigin)throws SQLException;
	...
	public ArrayList<WineInfo> selectByWineSellerWineInfo(Connection conn, String wineInfoName)throws SQLException;
