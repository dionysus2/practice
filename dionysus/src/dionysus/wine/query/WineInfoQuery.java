...
public interface WineInfoQuery {
	...
	//	와인상품 정보수정
	public String update="UPDATE WINE_INFO SET WINE_INFO_PROFILE_PICTURE=?, WINE_INFO_PRICE=?, WINE_INFO_ORIGIN=?, WINE_INFO_PICTURE1=?, WINE_INFO_PICTURE2=?, WINE_INFO_PICTURE3=?, WINE_SELLER_ID=? WHERE WINE_INFO_NAME=?";
	//	회사리스트별 상품조회
	...
	//	와인번호별 와인정보 조회
	public String selectByWineInfoId="SELECT WINE_INFO_NAME, WINE_INFO_PROFILE_PICTURE, WINE_INFO_PRICE, WINE_INFO_ORIGIN, WINE_INFO_PICTURE1, WINE_INFO_PICTURE2, WINE_INFO_PICTURE3, WINE_SELLER_ID FROM WINE_INFO WHERE WINE_INFO_ID=?";
}
